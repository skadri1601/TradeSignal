...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden font-sans selection:bg-purple-500/30">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        >
          <Link
            to="/dashboard"
            className="group relative inline-flex items-center gap-2 px-8 py-3.5 bg-purple-600 text-white rounded-full font-medium transition-all hover:bg-purple-700 hover:shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:scale-105 active:scale-95"
          >
