...
import { Mail, Lock, User, AlertCircle, TrendingUp, Check } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const getPasswordStrength = (pass: string): { strength: string; color: string; width: string } => {
    ...
    if (pass.length < 10 && !/[A-Z]/.test(pass)) return { strength: 'Medium', color: 'bg-yellow-500', width: '66%' };
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-gray-900 bg-white"
