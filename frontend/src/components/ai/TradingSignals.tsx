      ...
      <div className="card bg-red-50 border border-red-200">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-medium text-red-800">Failed to load trading signals</h3>
            <p className="text-sm text-red-700 mt-1">
              {isUnavailable 
                ? 'AI service is currently unavailable. Please ensure GEMINI_API_KEY is configured in the backend.'
                : errorMessage}
            </p>
            <button
              onClick={() => refetch()}
