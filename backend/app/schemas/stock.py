...
class TickerRequest(BaseModel):
    ...
    def validate_ticker(cls, v: str) -> str:
        ...
        if not re.match(r'^[A-Z0-9]{1,10}$', v):
            raise ValueError('Invalid ticker format. Must be 1-10 uppercase alphanumeric characters.')
        return v
    ...
    def validate_tickers(cls, v: List[str]) -> List[str]:
        ...
        for ticker in v:
            ...
            if not re.match(r'^[A-Z0-9]{1,10}$', ticker):
                raise ValueError(f'Invalid ticker: {ticker}. Must be 1-10 uppercase alphanumeric characters.')
