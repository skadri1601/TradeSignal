...
class CompanyBase(BaseModel):
    ...
    cik: str = Field(..., min_length=10, max_length=10, description="SEC Central Index Key")
...
class CompanySearch(BaseModel):
    ...
    query: Optional[str] = Field(None, min_length=1, description="Search query (ticker or name)")
