...
async def analyze_company_patterns_task(ticker: str, days_back: int = 90):
    """
...
async def analyze_all_active_companies_patterns_task():
    """
...
async def precompute_top_patterns_task():
    """
